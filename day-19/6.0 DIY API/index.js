...
app.get("/jokes/:id",(req,res)=>{
  ...
  const j=jokes.find((joke)=>joke.id===idnumber);
  res.json(j);
});

app.get("/filter",(req,res)=>{
  const f=req.query.type;
  const j=jokes.find((joke)=>joke.type===f);
  res.json(j);
});
...
app.post("/jokes",(req,res)=>{
    const njoke={
      id:jokes.length +1,
      jokeText:req.body.joketext||j.jokeText,
      jokeType:req.body.joketype||j.jokeType,
    };
...
app.put("/jokes/:id",(req,res)=>{
  ...
  const njoke={
    ...
    const ind=jokes.findIndex((joke)=>joke.id===idnumber);
    jokes[ind]=njoke;
    res.json(njoke);
...
app.patch("/jokes/:id",(req,res)=>{
  ...
  const njoke={
    id:idnumber,
    jokeText:j.jokeText||req.body.text,
    jokeType:j.jokeType||req.body.type,
  };
  const ind=jokes.findIndex((joke)=>joke.id===idnumber);
  jokes[ind]=njoke;
  res.json(njoke);
